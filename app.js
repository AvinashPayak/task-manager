...
db.execute("CREATE TABLE IF NOT EXISTS users (usersId int NOT NULL AUTO_INCREMENT, email varchar(100) NOT NULL, password varchar(100) NOT NULL,name varchar(100) NOT NULL,PRIMARY KEY (usersId),UNIQUE KEY usersId_UNIQUE (usersId),UNIQUE KEY email_UNIQUE (email))").then((result)=>{
